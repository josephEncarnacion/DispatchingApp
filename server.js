...
app.use(cors({
  origin: 'https://dispatchingapp-1.onrender.com', // Replace with your frontend's URL
...
app.post('/api/updateLocation', (req, res) => {
  ...
  responseTeamLocations[teamId] = { latitude, longitude, timestamp, teamId };
...
app.post('/register', async (req, res) => {
  ...
  try {
      ...
      // Hash the password before storing
        ...
        const role = 'user'
        await dbOperation.insertUser({ username, firstName, lastName, password: hashedPassword, role });
